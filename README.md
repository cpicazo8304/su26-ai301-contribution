...
- [x] CodSpeed Performance Analysis
- [x] docs/readthedocs.org:getdaft-docs
- [x] docs/readthedocs.org:getdaft-docs
- [x] PR Labeller / validate_pr_title (pull_request_target)
- [x] PR Labeller / validate_pr_title (pull_request_target)
- [x] PR test suite / benchmark-codspeed (pull_request)
- [x] PR test suite / benchmark-codspeed (pull_request)
- [x] PR test suite / check-unused-cargo-deps (pull_request)
- [x] PR test suite / check-unused-cargo-deps (pull_request)
- [x] PR test suite / doctests (pull_request)
- [x] PR test suite / doctests (pull_request)
- [x] PR test suite / integration-test-ai (3.10, native) (pull_request)
- [x] PR test suite / integration-test-ai (3.10, native) (pull_request)
- [x] PR test suite / integration-test-ai (3.10, ray) (pull_request)
- [x] PR test suite / integration-test-ai (3.10, ray) (pull_request)
- [x] PR test suite / integration-test-build (3.10) (pull_request)
- [x] PR test suite / integration-test-build (3.10) (pull_request)
- [x] PR test suite / integration-test-catalogs (pull_request)
- [x] PR test suite / integration-test-catalogs (pull_request)
- [x] PR test suite / integration-test-io (3.10, native) (pull_request)
- [x] PR test suite / integration-test-io (3.10, native) (pull_request)
- [x] PR test suite / integration-test-io (3.10, ray) (pull_request)
- [x] PR test suite / integration-test-io (3.10, ray) (pull_request)
- [x] PR test suite / integration-test-ray (pull_request)
- [x] PR test suite / integration-test-ray (pull_request)
- [x] PR test suite / integration-test-sql (native) (pull_request)
- [x] PR test suite / integration-test-sql (native) (pull_request)
- [x] PR test suite / integration-test-sql (ray) (pull_request)
- [x] PR test suite / integration-test-sql (ray) (pull_request)
- [x] PR test suite / integration-test-tpch (pull_request)
- [x] PR test suite / integration-test-tpch (pull_request)
- [x] PR test suite / integration-tests (pull_request)
- [x] PR test suite / integration-tests (pull_request
- [x] PR test suite / Publish coverage reports to CodeCov (pull_request)
- [x] PR test suite / Publish coverage reports to CodeCov (pull_request)
- [x] PR test suite / rust-dependency-budget (pull_request)
- [x] PR test suite / rust-dependency-budget (pull_request)
- [x] PR test suite / rust-tests (pull_request)
- [x] PR test suite / rust-tests (pull_request)
- [x] PR test suite / rust-tests-platform (ubuntu, false) (pull_request)
- [x] PR test suite / rust-tests-platform (ubuntu, false) (pull_request)
- [x] PR test suite / skipcheck (pull_request)
- [x] PR test suite / skipcheck (pull_request)
- [x] PR test suite / style (pull_request)
- [x] PR test suite / style (pull_request)
- [x] PR test suite / test-imports (pull_request)
- [x] PR test suite / test-imports (pull_request)
- [x] PR test suite / test-imports-platform (ubuntu, 3.10, false) (pull_request)
- [x] PR test suite / test-imports-platform (ubuntu, 3.10, false) (pull_request)
- [x] PR test suite / test-imports-platform (ubuntu, 3.11, false) (pull_request)
- [x] PR test suite / test-imports-platform (ubuntu, 3.11, false) (pull_request)
...
- [July 29]: I fixed the test cases, but the issue was closed.
